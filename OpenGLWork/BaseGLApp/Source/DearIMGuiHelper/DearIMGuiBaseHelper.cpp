...
DearIMGuiBaseHelper* DearIMGuiBaseHelper::s_Instance = nullptr;

DearIMGuiBaseHelper* DearIMGuiBaseHelper::GetInstance()
{
    if(s_Instance == nullptr)
    {
        s_Instance = new DearIMGuiBaseHelper();
    }
    return s_Instance;
}
...
void DearIMGuiBaseHelper::OnDrawWindow()
{
